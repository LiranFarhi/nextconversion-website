            ...
            <div className="relative w-full md:h-full md:w-auto md:shrink-0 md:aspect-[1327/754]">
              ...
              {AGENTS.map((a, i) => (
                <button
                  ...
                  className={`absolute top-[15%] -translate-x-1/2 rounded-full border px-3 py-0.5 font-inter text-xs font-normal leading-tight backdrop-blur-sm transition-all duration-500 sm:top-[18%] ${
                    i === index
