        ...
        {!submitted ? (
          <>
            ...
            <p className="text-muted text-sm mb-6">
              We&apos;ll build a personalized demo for your store. Takes 2 minutes to request.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Optional expanded fields — only shown on request */}
              {!showExtended ? (
                <button
                  type="button"
                ...
                >
                  + Add your name &amp; store URL for a personalized demo
                </button>
              ) : (
                <div className="space-y-4 animate-fade-in-up">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted mt-1">
                      Share your URL and we&apos;ll build a custom demo for your brand
                    </p>
                  </div>
                  <div>
                    <label
                    ...
                    <textarea
                      ...
                      placeholder="What platforms do you use? What's your biggest challenge with personalization?"
                    />
                  </div>
                </div>
              )}
          ...
          <div className="text-center py-6">
            ...
            <p className="text-muted">
              ...
              {website && " Since you shared your store URL, expect a personalized demo preview."}
            </p>
          </div>
        )}
      </div>
